...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DF] = LAYOUT_arrow_command( /* Default */
    ...
    KC_LCTL, KC_LALT,  KC_LGUI,   UTILTY,            SYMBOL,  KC_SPC,           FUNCTN,   KC_LEFT, KC_DOWN,  KC_RIGHT
  ),

  [_GM] = LAYOUT_arrow_command( /* Game */
    ...
    KC_LCTL,  KC_LALT,  KC_LGUI,   SPECAL,           KC_SPC,  KC_SPC,          FUNCTN,   KC_LEFT,  KC_DOWN,  KC_RIGHT
  ),

  [_SY] = LAYOUT_arrow_command( /* Symbols & SUBLIME */  
    ...
    _______, _______,  _______, _______,            XXXXXXX,  _______,           _______, DEIND,   LINED,   INDEN
  ),

  [_NM] = LAYOUT_arrow_command( /* Numbers */
    ...
    _______, _______, _______, _______,          _______, KC_SPC,         KC_0,  _______, LINED, _______
  ),
 
  [_FN] = LAYOUT_arrow_command( /* Function */
    ...
    _______, _______, _______, CMB_TOG,           _______, GAMES,            _______, _______, LAYDN,  _______ 
),

  [_UT] = LAYOUT_arrow_command( /* Utility */
    ...
    EMAIL,   GITHUB,  KEY,     _______,          _______, _______,          RGB_TOG, VIEW01,  _______, VIEW02
  ),  

  [_XT] = LAYOUT_arrow_command( /* Extra Utility */
  ...
  // [_TP] = LAYOUT_arrow_command( /* TEMPLATE */
